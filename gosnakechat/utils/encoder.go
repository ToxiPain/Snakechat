...
import (
	...
	// defproto "github.com/ToxiPain/snakechat/defproto"
	defproto "github.com/ToxiPain/snakechat/defproto"
	"go.mau.fi/whatsmeow"
...
func EncodeMessage(message *waProto.Message) *defproto.Message {
	var snakechatMessage defproto.Message
	encoded, err := proto.Marshal(message)
	if err != nil {
		panic(err)
	}
	err_decode := proto.Unmarshal(encoded, &snakechatMessage)
	if err_decode != nil {
		panic(err_decode)
	}
	return &snakechatMessage
}
