...
from snakechat.proto.waE2E.WAWebProtobufsE2E_pb2 import (
    Message,
    FutureProofMessage,
    InteractiveMessage,
    MessageContextInfo,
...
def handler(client: NewClient, message: MessageEv):
    ...
    match text:
        ...
        case "_test_link_preview":
            client.send_message(
                chat, "Test https://github.com/ToxiPain/snakechat", link_preview=True
            )
        case "_sticker":
            client.send_sticker(
                chat,
                    ...
                    viewOnceMessage=FutureProofMessage(
                        message=Message(
                            ...
                            interactiveMessage=InteractiveMessage(
                                ...
                                footer=InteractiveMessage.Footer(text="@ToxiPain"),
...
if __name__ == "__main__":
    # TODOS LOS CLIENTS SERÁN CREADOS AUTOMATICAMENTE
    client_factory.run()
